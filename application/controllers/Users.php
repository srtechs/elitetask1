...
class Users extends CI_Controller
{
	...
	public function index()
	{
		...
		$data = $this->customer_model->getall_customer();
	...
	public function userDocuments()
	{
		...
		$this->template->template_render('user_documents', $data);
	}
	...
	{
		$this->template->template_render('viewclient');
	}
	//editcustomer
	...
	public function insertcustomer()
	{
		...
		if ($response) {
			$this->session->set_flashdata('successmessage', 'New client added successfully');
			redirect(base_url() . 'users');
		} else {
			$errormsg = 'Error! Client already Exists.';
			$this->session->set_flashdata('warningmessage', $errormsg);
			redirect(base_url() . 'users/adduser');
		}
	}
