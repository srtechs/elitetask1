        ...
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid d-flex flex-column justify-content-center">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="floatingInputValue" placeholder="Group Name">
                            <label for="floatingInputValue">Group Name</label>
                        </div>
                        <div class="d-flex flex-row">
                            <div class="form-group my-2">
                                <label>Add Members</label>
                                <select class="selectpicker" aria-placeholder="add members.." multiple data-live-search="true">
                ...
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn btn-primary btn-md">Create </button>
