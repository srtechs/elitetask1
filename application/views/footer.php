<footer class="main-footer">
   <strong>Devloped By <a href="#" target="_blank">Buzzwaretech</a>.</strong>
...
<script src="<?= base_url(); ?>assets/custom-calendar.js"></script>
...
<!-- <script>
   const myurl = "<?php echo base_url() . 'trips/reademergency' ?>";
   var first_time_notification = true;
   ...
   function alertFunction() {
      ...
      $.post(myurl, '', function(response) {
         ...
         if (obj.soundStatus > 0) {
            const sound = new Audio('<?= base_url("assets/soundm.mp3") ?>');
