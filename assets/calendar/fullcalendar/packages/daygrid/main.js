    ...
    */
    ...
    var DayGrid = /** @class */ (function (_super) {
        ...
        DayGrid.prototype.renderNumberCellHtml = function (date) {
            ...
            html += '<td style="cursor:pointer;" class="' + classes.join(' ') + '"' +
                (isDateValid ?
                    ' data-date="' + dateEnv.formatIso(date, { omitTime: true }) + '"' :
                    '') +
                '>';
            ...
            html += '<i class="fa-solid fa-circle-plus text-custom-blue addevent" data-toggle="tooltip" data-placement="bottom" title="Add a visit to this day" style="margin-left:2rem;"></i></td>';
            return html;
        };
        /* Sizing
        ------------------------------------------------------------------------------------------------------------------*/
